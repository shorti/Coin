...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Systemcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"Systemcoin.net", "134.255.221.29"}, //seed node
    {NULL, NULL},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Systemcoin is probably already running."), addrBind.ToString().c_str());
        else
