...
static const unsigned int MAX_BLOCK_SIZE = 10000000;                      // Default for -blockmaxsize, which control the range of sizes the mining code will create
/** Obsolete: maximum size for mined blocks */
static const unsigned int MAX_BLOCK_SIZE_GEN = MAX_BLOCK_SIZE/2;         // Obsolete: maximum size for mined blocks
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 548 / 250; // 548 blocks/day , approx. 30 years of mining
    }
